<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::is('admin/photo/*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_photo_show') }}"><i class="fas fa-camera"></i> <span>Galeri foto</span></a></li>
            ...
            <li class="nav-item dropdown {{ Request::is('admin/page/*') ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ Request::is('admin/page/contact') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_page_contact') }}"><i class="fas fa-angle-right"></i> Kontak</a></li>
            ...
            <li class="{{ Request::is('admin/online-poll/*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_online_poll_show') }}"><i class="fas fa-vote-yea"></i> <span>Polling</span></a></li>
