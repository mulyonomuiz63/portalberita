...
<head>
    ...
    <style>
        ...
        .page-item.active .page-link {
            background: #<?php echo $global_setting_data->theme_color_1 ?> !important;
        }

        .acme-news-ticker,
        .page-item.active .page-link {
            border-color: #<?php echo $global_setting_data->theme_color_1 ?> !important;
        }
        ...
        ul.pagination .page-link {
            color: #<?php echo $global_setting_data->theme_color_1 ?> !important;
        }
        ...
        .tag-section-content span {
            background: #<?php echo $global_setting_data->theme_color_2 ?> !important;
        }
